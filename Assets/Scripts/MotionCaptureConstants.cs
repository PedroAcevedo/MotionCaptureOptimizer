...
public class MotionCaptureConstants
{
    ...
    public const float MOVE_ACTION_ADD_PROBABILITY = 0.3f;
    public const float MOVE_ACTION_MODIFY_PROBABILITY = 0.4f;
    public const float MOVE_ACTION_DELETE_PROBABILITY = 0.3f;
}
